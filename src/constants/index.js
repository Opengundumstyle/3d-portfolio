import {
  ...
  const testimonials = [
    ...
    {
      testimonial:
        "Brian’s thirst for knowledge and excitement to understand new technologies is inspirational. He never just says he wants to build a new application or learn something new, he actually acts on it. ",
      name: "Cindy Vuong",
