...
const ReactNativeModal = () => {
  return (
    <div className='mt-[20px]  flex flex-col items-center md:text-md sm:text-sm lg:text-lg'>
        ...
        <br />
        <br />
        <div className='text-[18px] p-[10px] '>I am planning to start another one soon  . . stay tune!</div>
    </div>
  )
}
